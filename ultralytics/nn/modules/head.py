...
__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect", "YOLOEDetect", "YOLOESegment", "QDetect", "Qv10Detect", "QATDetect", "QATv10Detect"
...
class QDetect(nn.Module):
    ...
    def forward_end2end(self, x: list[torch.Tensor]) -> dict | tuple:
        ...
        one2one = []
        for i in range(self.nl):
            out1 = self.one2one_cv2[i](x_detach[i])
            out2 = self.one2one_cv3[i](x_detach[i])
