...
class YOLO(Model):
    ...
    def __init__(self, model: str | Path = "yolo11n.pt", task: str | None = None, verbose: bool = False, q: bool = False):
        """
        ...
        if "-world" in path.stem and path.suffix in {".pt", ".yaml", ".yml"}:  # if YOLOWorld PyTorch model
            ...
            super().__init__(model=model, task=task, verbose=verbose, q=q)
